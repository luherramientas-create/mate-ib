...
export const QUESTIONS = [
  {
    ...
    subquestions: [
      { id:'a_i', label:'(a)(i)', prompt:'Escriba la dosis inicial del medicamento.', equation:String.raw`D(t)=23(0.85)^t`, acceptedAnswers:['23','23.0'], hints:h([
      ...
      { id:'a_ii', label:'(a)(ii)', prompt:'Escriba el porcentaje de medicamento que abandona el organismo cada hora.', equation:String.raw`D(t)=23(0.85)^t`, acceptedAnswers:['15','15%','0.15'], hints:h([
      ...
      { id:'b', label:'(b)', prompt:'Calcule la cantidad de medicamento que queda en el organismo 10 horas después de la inyección.', equation:String.raw`D(t)=23(0.85)^t`, acceptedAnswers:['4.53','4.528','4.5281','4.52811'], hints:h([
  ...
  },
  {
    ...
    subquestions: [
      { id:'a', label:'(a)', prompt:'Escriba el valor de \(A\).', equation:String.raw`P(t)=Ae^{kt}`, acceptedAnswers:['112'], hints:h([
      ...
      { id:'b', label:'(b)', prompt:'Halle el valor de \(k\).', equation:String.raw`P(t)=Ae^{kt}`, acceptedAnswers:['0.234','0.233','0.2340','0.2335'], tolerance:0.002, hints:h([
  ...
  },
  {
    ...
    subquestions: [
      { id:'a_i', label:'(a)(i)', prompt:'Halle la población de bulbules, al inicio de la temporada migratoria.', equation:String.raw`P=1350+400(1{,}25)^{-t}`, acceptedAnswers:['1750'], hints:h([
      ...
      { id:'a_ii', label:'(a)(ii)', prompt:'Halle la población de bulbules, en los humedales cuando han transcurrido 5 días.', equation:String.raw`P=1350+400(1{,}25)^{-t}`, acceptedAnswers:['1480','1481'], hints:h([
      ...
      { id:'b', label:'(b)', prompt:'Calcule el tiempo que tarda la población en descender por debajo de los 1400 ejemplares.', equation:String.raw`1400=1350+400(1{,}25)^{-t}`, acceptedAnswers:['9.32','9.31885','9.3'], tolerance:0.03, hints:h([
      ...
      { id:'c', label:'(c)', prompt:'Conforme a este modelo, halle cuál es el valor mínimo de la población de bulbules durante la temporada migratoria.', equation:String.raw`P=1350+400(1{,}25)^{-t}`, acceptedAnswers:['1350','1351'], hints:h([
  ...
  },
  {
    ...
    subquestions: [
      { id:'a_i', label:'(a)(i)', prompt:'Escribe el valor de \(P(0)\).', equation:String.raw`P(t)=1200\times k^t`, acceptedAnswers:['1200'], hints:h([
        '¿Qué valor de \\(t\\) representa el inicio del experimento?',
        'Sustituye \\(t=0\\). ¿Qué valor tiene \\(k^0\\)?',
        'Calcula \\(P(0)=1200\times k^0\\).',
        'Por tanto, \\(P(0)=1200\\).'
      ]) },
      { id:'a_ii', label:'(a)(ii)', prompt:'Interprete lo que significa este valor en este contexto.', equation:String.raw`P(0)=1200`, acceptedAnswers:['la población inicial de bacterias','la poblacion inicial de bacterias','población inicial de bacterias','poblacion inicial','1200 es la población inicial','1200 es la poblacion inicial'], conceptualKeywords:['poblacion','inicial','bacterias'], hints:h([
      ...
      { id:'b', label:'(b)', prompt:'Halle el valor de \(k\).', equation:String.raw`1200\times k^3=18750`, acceptedAnswers:['2.5','2.50'], hints:h([
      ...
      { id:'c', label:'(c)', prompt:'Halle cuál era la población de bacterias 1 hora y 30 minutos después de que empezara el experimento.', equation:String.raw`P(t)=1200\times2.5^t`, acceptedAnswers:['4740','4743.41','4743.4'], tolerance:0.02, hints:h([
      ...
      { id:'d', label:'(d)', prompt:'Halle el valor de \(t\) cuando las dos poblaciones de bacterias son iguales.', equation:String.raw`P(t)=1200\times2.5^t,\qquad S(t)=5000\times1.65^t`, acceptedAnswers:['3.43','3.43456','3.434'], tolerance:0.01, hints:h([
      ...
      { id:'e', label:'(e)', prompt:'Halle el valor de \(m\); dé la respuesta como un número entero.', equation:String.raw`S(t)=5000\times1.65^t`, acceptedAnswers:['40','40.0'], exact:true, hints:h([
      ...
      { id:'f', label:'(f)', prompt:'Determine cuánto tiempo tardarán las bacterias en llenar el recipiente.', equation:String.raw`S(t)=5000\times1.65^t`, acceptedAnswers:['44.2','44.24','44.2480'], tolerance:0.05, hints:h([
  ...
  },
  {
    ...
    subquestions: [
      { id:'d', label:'(d)', prompt:'Utilice el modelo de Diego para calcular el número de alumnos que empezaron el curso escolar con gripe.', equation:String.raw`n(t)=250-240(2)^{kt}`, acceptedAnswers:['10'], hints:h([
        '¿Qué valor de \\(t\\) representa el inicio del curso escolar?',
        'Al inicio, \\(t=0\\). Sustituye ese valor en el modelo.',
        'Calcula \\(n(0)=250-240(2)^{k(0)}\\).',
        'Como \\(2^0=1\\), queda \\(n(0)=250-240=10\\) alumnos.'
      ]) },
      { id:'e', label:'(e)', prompt:'Halle el valor de \(k\).', equation:String.raw`n(t)=250-240(2)^{kt}`, acceptedAnswers:['-0.1','−0.1'], tolerance:0.001, hints:h([
      ...
      { id:'f', label:'(f)', prompt:'Utilizando este modelo, calcule cuántos días transcurrirán desde el inicio del curso escolar hasta que haya 200 alumnos que hayan tenido gripe.', equation:String.raw`n(t)=250-240(2)^{-0.1t}`, acceptedAnswers:['22.6','22.6303','23'], tolerance:0.03, hints:h([
      ...
      { id:'g', label:'(g)', prompt:'Comente lo adecuado que resulta el modelo de Diego.', equation:String.raw`n(t)=250-240(2)^{-0.1t}`, acceptedAnswers:['el modelo no predice que n llegue a 300','el modelo no predice que n llegue a 300 alumnos','el modelo no es apropiado','no es apropiado','el modelo no alcanza 300'], conceptualKeywords:['modelo','adecuado'], hints:h([
  ...
  },
  {
    ...
    subquestions: [
      { id:'a', label:'(a)', prompt:'Halle la temperatura del café transcurridos 16 minutos desde que empezó a enfriarse.', equation:String.raw`T(t)=71e^{-0.0514t}+23`, acceptedAnswers:['54.2','54.1956'], tolerance:0.02, hints:h([
      ...
      { id:'b', label:'(b)', prompt:'Escriba la ecuación de la asíntota horizontal.', equation:String.raw`T(t)=71e^{-0.0514t}+23`, acceptedAnswers:['T=23','y=23','T(t)=23'], hints:h([
      ...
      { id:'c', label:'(c)', prompt:'Escriba la temperatura ambiente.', equation:String.raw`T=23`, acceptedAnswers:['23','23°C','23 C'], hints:h([
      ...
      { id:'d', label:'(d)', prompt:'Sabiendo que \(T^{-1}(50)=k\), halle el valor de \(k\).', equation:String.raw`50=71e^{-0.0514k}+23`, acceptedAnswers:['18.8','18.8101'], tolerance:0.03, hints:h([
  ...
  },
  {
    ...
    subquestions: [
      { id:'a', label:'(a)', prompt:'Escriba la masa inicial del carbono radioactivo.', equation:String.raw`m(t)=120e^{-0.000121t}`, acceptedAnswers:['120'], exact:true, hints:h([
      ...
      { id:'b', label:'(b)', prompt:'Halle la masa del carbono radioactivo luego de 20000 años.', equation:String.raw`m(t)=120e^{-0.000121t}`, acceptedAnswers:['10.7','10.6705'], tolerance:0.03, hints:h([
      ...
      { id:'c', label:'(c)', prompt:'Calcule el menor número de años completos que tarda en desintegrarse más de la mitad de la muestra.', equation:String.raw`m(t)=120e^{-0.000121t}`, acceptedAnswers:['5729'], exact:true, hints:h([
  ...
  },
  {
    ...
    subquestions: [
      { id:'a_i', label:'(a)(i)', prompt:'Para la muestra X: escriba el valor de \(a\).', equation:String.raw`f(t)=ab^t`, acceptedAnswers:['100'], hints:h([
        '¿Qué representa \\(a\\) cuando \\(t=0\\)?',
        'La cantidad inicial de la muestra X es 100 microgramos.',
        'Sustituye \\(t=0\\) y observa que \\(b^0=1\\).',
        'Por tanto, \\(a=100\\).'
      ]) },
      { id:'a_ii', label:'(a)(ii)', prompt:'Para la muestra X: halle \(b\), sabiendo que \(b>0\).', equation:String.raw`f(t)=100b^t`, acceptedAnswers:['0.995','0.994989'], tolerance:0.001, hints:h([
      ...
      { id:'b', label:'(b)', prompt:'Utilice el valor de \(b\) que halló en el apartado (a)(ii) para hallar la cantidad inicial de material radioactivo que contenía la muestra Y.', equation:String.raw`f(t)=ab^t`, acceptedAnswers:['4.65','4.65051'], tolerance:0.01, hints:h([
